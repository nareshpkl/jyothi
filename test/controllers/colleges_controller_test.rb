...
class CollegesControllerTest < ActionController::TestCase
  ...
  test "should create college" do
    assert_difference('College.count') do
      post :create, college: { administration: @college.administration, principal: @college.principal, staff: @college.staff, students: @college.students }
    end
  ...
  test "should update college" do
    patch :update, id: @college, college: { administration: @college.administration, principal: @college.principal, staff: @college.staff, students: @college.students }
    assert_redirected_to college_path(assigns(:college))
  end
